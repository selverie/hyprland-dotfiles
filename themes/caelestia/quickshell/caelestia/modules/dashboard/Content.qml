    ...
    ClippingRectangle {
        ...
        Flickable {
            ...
            Component {
                ...
                Item {
                    implicitWidth: Config.dashboard.sizes.weatherWidth + Config.dashboard.sizes.infoWidth + Config.dashboard.sizes.dateTimeWidth + Config.dashboard.sizes.mediaWidth + Appearance.spacing.normal * 3
                    implicitHeight: 500
